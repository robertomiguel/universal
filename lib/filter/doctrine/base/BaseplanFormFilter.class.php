...
abstract class BaseplanFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'rubro_id'    => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('rubro'), 'add_empty' => true)),
      ...
      'info_url'    => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      'rubro_id'    => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('rubro'), 'column' => 'id')),
