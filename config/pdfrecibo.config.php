...
//-------------------------- BANCO
$pdf->SetXY(123,117);$pdf->Cell(0,0, "Santander Río", '', 0, '', false);
$pdf->SetXY(123,121);$pdf->Cell(0,0, "Cuenta NRO.: 118-17127/4", '', 0, '', false);
$pdf->SetXY(123,125);$pdf->Cell(0,0, "CBU: 0720118520000001712740", '', 0, '', false);
